...
export default class Landing extends React.Component {
    ...
    return (
        ...
        <div className="text-center" id="aboutus">
            ...
            You go out a lot. You shouldn&apos;t waste your time deciding who p
            ays for what and how much. You deserve PayShare so we made it for y
            ou. Enjoy!
            </p>

            <h3 id="info-title1">Track Your Expenses</h3>
            <p className="text-right" id="info-text1">
            Get an overview on how much you&apos;ve spent going out to eat. You
            can quickly scan through your expenses or get an in depth overview
            on individual spendings.
            </p>
        </div>
